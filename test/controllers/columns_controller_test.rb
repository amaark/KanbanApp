...
class ColumnsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create column" do
    assert_difference('Column.count') do
      post columns_url, params: { column: { board_id: @column.board_id, column_title: @column.column_title, limit: @column.limit } }
    end
  ...
  test "should update column" do
    patch column_url(@column), params: { column: { board_id: @column.board_id, column_title: @column.column_title, limit: @column.limit } }
